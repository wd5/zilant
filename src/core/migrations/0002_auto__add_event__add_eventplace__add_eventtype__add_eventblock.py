...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_event', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='type', to=orm['core.EventType'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='place', to=orm['core.EventPlace'])),
            ('block', self.gf('django.db.models.fields.related.ForeignKey')(related_name='block', to=orm['core.EventBlock'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('additional', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('stuff', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('dt', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['Event'])

        # Adding model 'EventPlace'
        db.create_table('core_eventplace', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('core', ['EventPlace'])
        ...
        # Adding model 'EventBlock'
        db.create_table('core_eventblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('core', ['EventBlock'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_eventplace')

        # Deleting model 'EventType'
        db.delete_table('core_eventtype')

        # Deleting model 'EventBlock'
        db.delete_table('core_eventblock')
